...
For Snowflake, we use a **marketplace share**. We need the appropriate Snowflake account information from you (e.g., account identifier, region if relevant) so we can add you to the share. For where to find your account identifier and related details, see <a href="https://docs.snowflake.com/en/user-guide/admin-account-identifier" target="_blank" rel="noopener noreferrer">Snowflake's account identifier documentation</a>. Once the share is set up, you’ll have access to the database and schemas you’ve licensed.
