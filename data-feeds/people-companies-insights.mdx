...
Field names, descriptions, and examples are sourced from the [Contacts](/data-feeds/contacts), [Companies](/data-feeds/companies), and [Insights](/data-feeds/insights) table pages. This pre-joined table includes all person fields (suffix `_PER`), all company fields (suffix `_ORG` from Companies category), and all insight fields (suffix `_ORG` from Company Insights category).
...
- [Contacts](/data-feeds/contacts), [Companies](/data-feeds/companies), and [Insights](/data-feeds/insights) for the complete field reference.
