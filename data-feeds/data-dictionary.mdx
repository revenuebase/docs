...
For full column lists and table-specific notes, see the individual table pages under [Tables & Schema](/data-feeds/tables-schema) (e.g., [Companies](/data-feeds/companies), [Contacts](/data-feeds/contacts)).
