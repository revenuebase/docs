...
- **Snowflake private share** — We share tables directly to your Snowflake account. No data movement required; query in place.
...
For setup instructions, see the [Data Feeds Quickstart](/getting-started/quickstart-data-feeds) or [Gigasheet Quickstart](/getting-started/quickstart-gigasheet).
</Accordion>
...
This creates a `RELEASES` database in your Snowflake account containing the shared tables. See the [Data Feeds Quickstart](/getting-started/quickstart-data-feeds) for detailed setup steps.
</Accordion>
