...
For S3 bucket deliveries, we support:
...
Let us know your preferred format during onboarding. You can change formats between deliveries.
</Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Get Support" icon="headset" href="/support">
    Schedule a call or reach out to the RevenueBase team.
  </Card>
</CardGroup>
