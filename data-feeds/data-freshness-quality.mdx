...
A record is "re-verified" when the source profile was accessible and we confirmed or updated at least the core profile information — name, current title, company association, and location. This is distinct from simply checking that a URL resolves. Verification means we read the profile content and either confirmed it matches our existing record or updated our record to reflect changes.
