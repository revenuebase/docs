...
Field names, descriptions, and examples are sourced from the [Contacts](/data-feeds/contacts) and [Companies](/data-feeds/companies) table pages. This pre-joined table includes all person fields (suffix `_PER`) and all company fields (suffix `_ORG`).
