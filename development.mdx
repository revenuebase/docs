...
We suggest using extensions on your IDE to recognize and format MDX. If you're a VSCode user, consider the <a href="https://marketplace.visualstudio.com/items?itemName=unifiedjs.vscode-mdx" target="_blank" rel="noopener noreferrer">MDX VSCode extension</a> for syntax highlighting, and <a href="https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode" target="_blank" rel="noopener noreferrer">Prettier</a> for code formatting.
...
Curious about what changed in the latest CLI version? Check out the <a href="https://www.npmjs.com/package/mintlify?activeTab=versions" target="_blank" rel="noopener noreferrer">CLI changelog</a>.
